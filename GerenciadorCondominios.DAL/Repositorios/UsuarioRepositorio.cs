...
namespace GerenciadorCondominios.DAL.Repositorios
{
    public class UsuarioRepositorio : RepositorioGenerico<Usuario>, IUsuarioRepositorio
    {
        ...
        public int VerificarExistenciaRegistro()
        {
            try
            {
        ...
        public async Task<bool> VerificarUsuarioFuncao(Usuario usuario, string funcao)
        {
            try
            {
        ...
        public async Task<IEnumerable<string>> RecuperarFuncoesUsuario(Usuario usuario)
        {
            try
            {
        ...
        public async Task<IdentityResult> RemoverFuncoesUsuario(Usuario usuario, IEnumerable<string> listaFuncoes)
        {
            try
            {
                return await _gerenciadorUsuarios.RemoveFromRolesAsync(usuario, listaFuncoes);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async Task<IdentityResult> IncluirUsuarioEmFuncoes(Usuario usuario, IEnumerable<string> listaFuncoes)
        {
            try
            {
                return await _gerenciadorUsuarios.AddToRolesAsync(usuario, listaFuncoes);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async Task<Usuario> RecuperarPorcodigo(string codigoUsuario)
        {
            try
            {
                return await _gerenciadorUsuarios.FindByIdAsync(codigoUsuario);
            }
            catch (Exception ex)
            {
                throw ex;
